...
مرِّر فوق أيّ كتلة وانقر مقبض `⠿` لقائمة سريعة تعمل على تلك الكتلة:
...
ملفّ `settings.toml` واحد وموثَّق بالتعليقات بجوار الملفّ التنفيذيّ. حرّره في أيّ
محرّر نصوص وسيلتقط Mowl **التغيير خلال ثانية — دون إعادة تشغيل**. إذا كان مجلَّد
البرنامج للقراءة فقط، يعود Mowl إلى مجلَّد إعداد نظام التشغيل ويخبرك بذلك في
النافذة. كلّ إصدار يرافقه أيضًا `settings.example.toml` موثَّق بالكامل كمرجع.
...
إذا كان Mowl يوفّر وقتك، يمكنك دعم تطويره على
