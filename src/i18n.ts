...
const EN = {
  ...
  "update.dot": "update available",
  "update.check": "Check for updates",
  "update.checking": "Checking…",
  "update.latest": "Mowl is up to date.",
  "update.available": "Version {version} is available.",
  "update.seeAbout": "Open About to install it.",
  "update.download": "Download update",
  "update.downloading": "Downloading…",
  "update.ready": "Version {version} is downloaded and verified. Restart Mowl to install it.",
  "update.restart": "Restart & update",
  "update.install": "Run installer",
  "update.releasePage": "Release notes",
  "update.failed": "Update failed: {err}",
  "update.unsavedInstall": "You have unsaved changes. Install the update anyway? Unsaved changes will be lost.",
  "update.reason.scoop": "Installed with Scoop — update with: scoop update mowl",
  "update.reason.managed": "This copy is managed elsewhere (a build folder or an MSI install) — get the update from the release page.",
  "update.reason.unsigned": "The signed download for this version is not published yet — try again later, or use the release page.",
  "update.reason.arch": "There is no automatic update for this build — use the release page.",
  "update.reason.readonly": "This folder is read-only, so Mowl cannot replace itself — use the release page.",
  ...
  "image.scale": "Scale, relative to the original size",
  "image.delete": "Remove image",
  "settings.section.system": "System",
  "settings.openWith": "Add Mowl to the “Open with” menu for Markdown files",
  "settings.openWith.hint": "Windows only. Afterwards pick Mowl under Open with → Choose another app → Always to make it the default.",
  ...
  "settings.shortcut.conflict": "Already in use",
  "settings.shortcut.invalid": "Needs Ctrl/Cmd or Alt; reserved keys are off-limits",
...
const DE: Partial<Record<I18nKey, string>> = {
  ...
  "toolbar.open.title": "Neu / Öffnen",
  "toolbar.open.aria": "Neue Datei / Datei öffnen",
  "toolbar.save.title": "Speichern",
  ...
  "update.dot": "Update verfügbar",
  "update.check": "Nach Updates suchen",
  "update.checking": "Prüfe …",
  "update.latest": "Mowl ist auf dem neuesten Stand.",
  "update.available": "Version {version} ist verfügbar.",
  "update.seeAbout": "Zum Installieren „Über“ öffnen.",
  "update.download": "Update herunterladen",
  "update.downloading": "Lade herunter …",
  "update.ready": "Version {version} ist heruntergeladen und geprüft. Starte Mowl neu, um sie zu installieren.",
  "update.restart": "Neu starten & aktualisieren",
  "update.install": "Installer starten",
  "update.releasePage": "Versionshinweise",
  "update.failed": "Update fehlgeschlagen: {err}",
  "update.unsavedInstall": "Es gibt ungespeicherte Änderungen. Update trotzdem installieren? Ungespeicherte Änderungen gehen verloren.",
  "update.reason.scoop": "Mit Scoop installiert — aktualisiere mit: scoop update mowl",
  "update.reason.managed": "Diese Kopie wird anderweitig verwaltet (Build-Ordner oder MSI-Installation) — hol dir das Update von der Release-Seite.",
  "update.reason.unsigned": "Der signierte Download für diese Version ist noch nicht veröffentlicht — versuche es später oder nutze die Release-Seite.",
  "update.reason.arch": "Für diesen Build gibt es kein automatisches Update — nutze die Release-Seite.",
  "update.reason.readonly": "Dieser Ordner ist schreibgeschützt, Mowl kann sich nicht selbst ersetzen — nutze die Release-Seite.",
  "settings.autoUpdate": "Automatisch nach Updates suchen",
  "settings.checkNow": "Jetzt prüfen",
  "image.alignLeft": "Linksbündig",
  "image.alignCenter": "Zentriert",
  "image.alignRight": "Rechtsbündig",
  "image.scale": "Skalieren, relativ zur Originalgröße",
  "image.delete": "Bild entfernen",
  "settings.section.system": "System",
  "settings.openWith": "Mowl im Menü „Öffnen mit“ für Markdown-Dateien anbieten",
  "settings.openWith.hint": "Nur unter Windows. Danach unter Öffnen mit → Andere App auswählen → Immer als Standard festlegen.",
  ...
  "settings.shortcut.export": "Als HTML / PDF exportieren",
  "settings.shortcut.toggleSource": "Quelltext-Ansicht umschalten",
  ...
  "settings.shortcut.capture": "Kürzel drücken…",
  "settings.shortcut.cancelHint": "Esc zum Abbrechen",
  "settings.shortcut.conflict": "Bereits vergeben",
  "settings.shortcut.invalid": "Braucht Strg/Cmd oder Alt; reservierte Tasten sind gesperrt",
